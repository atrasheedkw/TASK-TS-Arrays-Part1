...
function createGroceries(): string[] {
  ...
  return groceryItems; // replace empty array with what you see is fit
}
...
function getFirstThreeGroceryItems(groceries: string[]): string[] {
  // write your code here...
  let deletedGroceries: string[] = groceries.slice(0, 3);
  return deletedGroceries; // replace empty array with what you see is fit
}
